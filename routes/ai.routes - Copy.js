...
router.post('/search', authMiddleware, async (req, res) => {
    try {
        ...
        const parsed = await aiHelper.parseSearchQuery(query.trim());
...
router.get('/analyze', authMiddleware, async (req, res) => {
    try {
        ...
        const analysis = await aiHelper.analyzeData(statisticsData);
...
router.get('/suggestions/:field', authMiddleware, async (req, res) => {
    try {
        ...
        const suggestions = await aiHelper.getSuggestions(field, value || '', { area });
